                ...
                <div className="_cn">
                            ...
                            <div className="_se _se3a">
                                <div className="_c5x312 _c5m312 _pd3n3lr _ta">
                                    <ul className="_ta5l">
                                        ...
                                        <li>
                                            <a className="_ta5l3a" href="">Algortma Pemrograman</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div className="_ro _c5m38 _c5x312 _pd5m3n">
                        ...
                        <div className="_c5x312 _c5m312">
                            <div className="_c5x312 _c5m312 _pd3n3lr">
                                <div className="_c5x312 _c5m312 _pd3n3lr _ta">
                                    <ul className="_ta5l _el3">
                                        <li>
                                            <a className="_ta5l3a" id="btn_assign">Assignment</a>
                                        </li>
                                        <li>
                                            <a className="" id="btn_attend">Attendance</a>
                                        </li>
                                        <li>
                                            <a className="" id="btn_downld">Download</a>
                                        </li>
                                        <li>
                                            <a className="" id="btn_assist">Assistant</a>
                                        </li>
                                        <li>
                                            <a className="" id="btn_grade">Grade</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
